                    ...
                    <div key={gift.id} className="col-md-4 mb-4">
                        <div className="card product-card">
                            ...
                            <div className="image-placeholder">
                                {gift.image ? (
                                    <img src={gift.image.startsWith('http') ? gift.image : `${urlConfig.backendUrl}${gift.image}`} alt={gift.name} />
                                ) : (
                            ...
                            <div className="card-body">
                                ...
                                <button onClick={() => goToDetailsPage(gift.id)} className="btn btn-primary mt-3">
                                    View Details
                                </button>
                            </div>
                        </div>
