...
const logger = require('./logger'); // Note: ensure you copy logger.js from backend to this folder
...
const app = express();
const port = process.env.PORT || 3080; // Typically 3080 to avoid conflict with frontend (3000)
